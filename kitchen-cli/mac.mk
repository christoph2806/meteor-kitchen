...
IncludePCH             := 
RcIncludePath          := 
Libs                   := $(LibrarySwitch)git2 $(LibrarySwitch)curl $(LibrarySwitch)z $(LibrarySwitch)iconv
ArLibs                 :=  "git2" 
