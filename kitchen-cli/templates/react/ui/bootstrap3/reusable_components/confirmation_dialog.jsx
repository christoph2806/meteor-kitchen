...
export class ConfirmationBox extends Component {
	...
	componentDidMount() {
		var self = this;
		$("#confirmation-dialog.modal").modal();
		$("#confirmation-dialog.modal").on("hidden.bs.modal", function (e) {
	...
	render() {
		return (
			<div id="confirmation-dialog" className="modal" tabIndex="-1" role="dialog">
