...
Template.TEMPLATE_NAME.events({
	...
	"click #dataview-export-default": function(e, t) {
		e.preventDefault();
		EXPORT_FUNCTION.call(this, this.QUERY_VAR, "csv");
	},
	...
	"click #dataview-export-tsv": function(e, t) {
		e.preventDefault();
		EXPORT_FUNCTION.call(this, this.QUERY_VAR, "tsv");
	},

	"click #dataview-export-json": function(e, t) {
		e.preventDefault();
		EXPORT_FUNCTION.call(this, this.QUERY_VAR, "json");
	}
...
Template.TEMPLATE_NAME.helpers({
	...
	"viewAsBlog": function() {
		return pageSession.get("VIEW_STYLE_SESSION_VAR") == "blog";
	},
	"viewAsList": function() {
