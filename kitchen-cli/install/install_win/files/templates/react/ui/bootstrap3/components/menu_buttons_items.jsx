...
<div id="menu-item-dropdown" className="btn-group" role="group">
	<a className="ITEM_CLASS dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" href="ITEM_LINK"><span id="item-icon" className="ICON_CLASS"></span> <span className="item-title">ITEM_TITLE</span>&nbsp;<span className="caret"></span></a>
