					...
					<div className="modal-content">
							...
							<form>
								<div className="form-group">
									...
									{this.props.multiline ? (
										...
										<input type="text" name="input-box" defaultValue={this.props.text} className="form-control input-control" autoFocus={true} />
									)}
								</div>
							</form>
						</div>
						<div className="modal-footer">
							...
							<button type="button" className="btn btn-primary submit-button" onClick={this.onClickSubmitButton}>
								{this.props.buttonSubmitTitle || "OK"}
							</button>
						</div>
					</div>
				</div>
