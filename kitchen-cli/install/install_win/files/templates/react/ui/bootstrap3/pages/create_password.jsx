	...
	onSubmit(e) {
		...
		getFormData(e.target, {
			onSuccess: function(values) {
				...
				Accounts.resetPassword(self.props.routeParams.createPasswordToken, values.newPassword, function(err) {
		...
		if(this.props.data.dataLoading) {
			...
			return (
				<div className="page-container" id="content">
					...
					<form id="create_password_form" className="account-form" role="form" onSubmit={this.onSubmit}>
						<h2 className="account-form-heading">Please create your password</h2>
