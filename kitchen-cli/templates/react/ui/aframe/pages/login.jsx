			...
			return (
				<div className="page-container" id="content">
					<form id="login_form" className="account-form" role="form" onSubmit={this.onLoginWithPassword}>
						...
						<button id="login-with-auth0" type="button" className="btn btn-default btn-block" data-loading-text="Please wait..." onClick={this.onLoginWithAuth0}><span className="fa fa-star"></span>&nbsp;Sign in with Auth0</button>
